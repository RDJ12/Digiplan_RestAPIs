...
public class QueryServiceImplTests {
	...
	@Test
	public void test_getAllQueries() throws Exception {
	...
	@Test
	public void test_addQuery() throws Exception {
		Query query = new Query("1", "Karan", 9999999999L, "karankumar12@gmail.com", "demo");
	...
	@Test
	public void test_updateQuery() throws Exception {
		Query query = new Query("1", "Karan", 9999999999L, "karankumar12@gmail.com", "demo");
	...
	@Test
	public void test_deleteQuery() throws Exception {
		String queryId = "1";
